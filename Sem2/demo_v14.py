...
def save_log_to_json(data_log, filename="data_log2.json"):
...
def main(live_plot = 0, visualise = 0):
    ...
    data_log_name = "data_log3.json"
    video_name = 'output3.avi'

    data_log = []
    timing_log = []

    fourcc = cv2.VideoWriter_fourcc(*'XVID')
    out = cv2.VideoWriter(video_name, fourcc, 15.0/2, (1280, 720))
    ...
    tvecs_world, rvecs_world, _ = orient(k4a, camera_matrix, distortion_coefficients)
