...
def create_cv_kalman(initial_state, Q, R):
...
def main():
    ...
    KF = create_cv_kalman(initial_state, Q, R)
        ...
        if detection:
            ...
            if person_kf_initialized:
                ...
                if last_detection is not None:
                    ...
                    person_KF = create_cv_kalman(initial_detection, Q, R)
